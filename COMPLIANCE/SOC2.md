...
| CC7.1 (Change detection) | Branch = `microfrontend_BE_nodejs24_FE_reactjs22_FE_angularjs19`, Node.js 24.x - version and provenance are pinned per branch |
...
This declaration covers the backend service in this branch (`microfrontend_BE_nodejs24_FE_reactjs22_FE_angularjs19`). It is a repository-level control mapping, not an attestation issued by an auditor.
