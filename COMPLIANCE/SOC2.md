...
| CC7.1 (Change detection) | Branch = `microfrontend_BE_nodejs20_FE_reactjs22_FE_angularjs17`, Node.js 20.x - version and provenance are pinned per branch |
...
This declaration covers the backend service in this branch (`microfrontend_BE_nodejs20_FE_reactjs22_FE_angularjs17`). It is a repository-level control mapping, not an attestation issued by an auditor.
